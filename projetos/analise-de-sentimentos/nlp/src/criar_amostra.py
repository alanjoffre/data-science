...
def criar_amostra():
    ...
    # Selecionar as primeiras 10000 linhas
    logger.info("Selecionando as primeiras 10000 linhas do dataset.")
    amostra_df = df.head(10000)  # 'head' carrega apenas as primeiras linhas no formato pandas

    # Caminho para salvar a amostra
    amostra_path = config['directories']['processed_data'] + 'amostra.parquet'
