...
def criar_amostra():
    ...
    # Selecionar as primeiras 50000 linhas
    logger.info("Selecionando as primeiras 50000 linhas do dataset.")
    amostra_df = df.head(50000)  # 'head' carrega apenas as primeiras linhas no formato pandas
